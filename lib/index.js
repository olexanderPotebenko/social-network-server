  ...
  switch(routs[0]){
    ...
    case 'profile':
      ...
      if(routs.includes('avatar') && routs.includes('profile'))
        users.getAvatarPicture2(req, res); //при использовании данного метода, так как адресс один и тот же, браузер кеширует фото по адресу и не возвращает новое фото
      break;
    case 'auth':
      if(routs[1] == 'me'){
